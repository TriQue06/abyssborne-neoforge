...
public class AbyssBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_AZURE_HUGE_FUNGUS = registerKey("add_azure_huge_fungus");
    public static final ResourceKey<BiomeModifier> ADD_NIGHT_HUGE_FUNGUS = registerKey("add_night_huge_fungus");
    public static final ResourceKey<BiomeModifier> ADD_AMBER_HUGE_FUNGUS = registerKey("add_amber_huge_fungus");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_AZURE_HUGE_FUNGUS, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(AbyssBiomeTags.IS_AZURE_GROVE),
                HolderSet.direct(placedFeatures.getOrThrow(AbyssPlacedFeatures.AZURE_FUNGI)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

        context.register(ADD_NIGHT_HUGE_FUNGUS, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(AbyssBiomeTags.IS_NIGHT_GROVE),
                HolderSet.direct(placedFeatures.getOrThrow(AbyssPlacedFeatures.NIGHT_FUNGI)),
                GenerationStep.Decoration.VEGETAL_DECORATION));

        context.register(ADD_AMBER_HUGE_FUNGUS, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(AbyssBiomeTags.IS_AMBER_GROVE),
                HolderSet.direct(placedFeatures.getOrThrow(AbyssPlacedFeatures.AMBER_FUNGI)),
                GenerationStep.Decoration.VEGETAL_DECORATION));
