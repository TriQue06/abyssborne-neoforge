...
public final class AbyssFluidTypes {
    ...
    public static final DeferredRegister<FluidType> FLUID_TYPES =
            DeferredRegister.create(NeoForgeRegistries.FLUID_TYPES, Abyssborne.MODID);

    public static final DeferredHolder<FluidType, FluidType> PURPLE_LAVA_TYPE =
            FLUID_TYPES.register("purple_lava", () ->
                    new FluidType(FluidType.Properties.create()
                            .descriptionId("fluid." + Abyssborne.MODID + ".purple_lava")
                            .lightLevel(15)
                            .density(3000)
                            .viscosity(6000)
                            .temperature(1300)
                            ...
                            consumer.accept(new IClientFluidTypeExtensions() {
                                ...
                                public ResourceLocation getStillTexture() {
                                    return ResourceLocation.fromNamespaceAndPath(
                                            Abyssborne.MODID, "block/purple_lava_still");
                                }

                                @Override
                                public ResourceLocation getFlowingTexture() {
                                    return ResourceLocation.fromNamespaceAndPath(
                                            Abyssborne.MODID, "block/purple_lava_flow");
                                }
                                ...
                                public @Nullable ResourceLocation getRenderOverlayTexture(Minecraft mc) {
                                    ...
                                    return ResourceLocation.fromNamespaceAndPath(
                                            Abyssborne.MODID, "textures/misc/purple_lava_overlay.png");
                                }
